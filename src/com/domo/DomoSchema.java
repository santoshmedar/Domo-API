...
public class DomoSchema {
	public void setkeyColumns(UpsertData upsertData ,DatasetManager manager, String dataSetId) throws Exception {
		...
		for (int i = 0; i < upsertData.keyColumns.length; i++) 
			schema.getColumn(upsertData.keyColumns[i].trim()).setUpsertKey(true);
